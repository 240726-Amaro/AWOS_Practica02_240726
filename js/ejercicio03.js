...
//1.Funciones Procedurales, funciones vacias(VOID) o funciones que no regresan ningun valor
...
console.warn("Funciones Procedurales");
saludar();
...
//3.Funciones que no retornan un valor pero que no reciben parametros (datos de entrada)
...
//4.Funciones que retornan un vlor, pero no tienen parametros (datos de entrada)
...
function login(username, password)
{
    ...
    else if (username==="admin"  && password!="12345")
    {
        ...
        console.log("Error con la contraseña de admin");
    }
    else if(username!="admin" && password=="12345")
    {
        userValidation= false;
    ...
    {
        userValidation=false;
        console.log("Por favor verifica el usuario y la contraseña son incorrectos.");
    }
...
//FUNCIONES ANONIMAS, FUNCIONES FLECHA (ARROW), LAMBA
...
recoverPassword("jose@gmail.com", 
